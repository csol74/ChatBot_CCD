...
import { consultarCalendario } from '../services/chatService';
...
export default function CalendarioScreen() {
  ...
  const cargar = async () => {
    setCargando(true);
    setError(false);
    const data = await consultarCalendario(idEstudiante);
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View>
          <Text style={styles.headerTitle}>Calendario CCD</Text>
          <Text style={styles.headerSub}>Eventos y fechas importantes</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.body}>
        {cargando ? (
          <View style={styles.centrado}>
            ...
            <Text style={styles.cargandoText}>Consultando eventos...</Text>
          </View>
        ) : error ? (
          <View style={styles.centrado}>
            <Text style={styles.errorText}>No se pudo cargar el calendario</Text>
          ...
          <View style={styles.respuestaCard}>
            <Text style={styles.respuestaLabel}>📅 Próximos eventos</Text>
            <Text style={styles.respuestaTexto}>{respuesta || 'No hay eventos disponibles por ahora.'}</Text>
          </View>
        )}
      </ScrollView>
    </SafeAreaView>
